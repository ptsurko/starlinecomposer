(function() {
  d3.rayChart = function(options) {
    ...
    function draw(g) {
      ...
      //   //.transition()
      //   .attr("x", "0")// function(d, i) {return radius * Math.sin(i * cfg.radians / total) + 40 * Math.sin(i * cfg.radians / total);})
      //   .attr("y", "0");//function(d, i) {return radius * Math.cos(i * cfg.radians / total) - 20 * Math.cos(i * cfg.radians / total);});
      //
      //
      //
      // axisSelection
